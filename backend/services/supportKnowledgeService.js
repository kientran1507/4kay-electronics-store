const entries = [
  ...
  { keywords: ["payment method", "pay on delivery", "cod", "payment"], answer: "Checkout supports cash on delivery and secure PayOS bank or VietQR payment. For online payment, the store creates the order and sends you directly to PayOS; payment credentials are never stored by 4Kay Store." },
